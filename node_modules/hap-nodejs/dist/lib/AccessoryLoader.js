...
var debug = debug_1.default('AccessoryLoader');
/**
...
function parseCharacteristicJSON(json) {
    ...
    if (updateFunc) {
        characteristic.on(Characteristic_1.CharacteristicEventTypes.SET, function (value, callback) {
            updateFunc(value);
            callback && callback();
        });
    }
    if (readFunc) {
        characteristic.on(Characteristic_1.CharacteristicEventTypes.GET, function (callback) {
