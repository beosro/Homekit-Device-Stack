...
export declare enum EventedHTTPServerEvents {
    LISTENING = "listening",
    REQUEST = "request",
    DECRYPT = "decrypt",
    ENCRYPT = "encrypt",
...
export declare class EventedHTTPServer extends EventEmitter<Events> {
    ...
    stop: () => void;
    sendEvent: (event: string, data: string | Buffer, contentType: string, exclude?: Record<string, boolean> | undefined) => void;
...
export declare enum HAPSessionEvents {
    CLOSED = "closed"
}
...
declare class EventedHTTPServerConnection extends EventEmitter<Events> {
    ...
    sendEvent: (event: string, data: string | Buffer, contentType: string, excludeEvents?: Record<string, boolean> | undefined) => void;
    close: () => void;
    _sendPendingEvents: () => void;
    _onHttpServerListening: () => void;
    _onServerSocketConnect: () => void;
    _onClientSocketData: (data: Buffer) => void;
    _onServerSocketData: (data: string | Buffer) => void;
    _onServerSocketClose: () => void;
    _onServerSocketError: (err: Error) => void;
    _onHttpServerRequest: (request: http.IncomingMessage, response: http.OutgoingMessage) => void;
