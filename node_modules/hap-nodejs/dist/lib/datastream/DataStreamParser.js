...
var debug = debug_1.default("DataStream:Parser");
...
(function (DataStreamParser) {
    function decode(buffer) {
        ...
        if (tag === DataFormatTags.INVALID) {
            ...
            var length = tag - DataFormatTags.UTF8_LENGTH_START;
            ...
            var length = tag - DataFormatTags.DATA_LENGTH_START;
            ...
            var length = tag - DataFormatTags.DICTIONARY_LENGTH_START;
            var dictionary = {};
            for (var i = 0; i < length; i++) {
