...
import { CharacteristicData, NodeCallback, PairingsCallback, VoidCallback } from '../types';
import { EventEmitter } from './EventEmitter';
import { PairingInformation } from "./model/AccessoryInfo";
export declare type Types = TLVValues;
...
export declare enum HapRequestMessageTypes {
...
export declare type HapRequest = {
...
export declare enum HAPServerEventTypes {
    IDENTIFY = "identify",
    LISTENING = "listening",
    PAIR = "pair",
...
export declare class HAPServer extends EventEmitter<Events> {
    accessoryInfo: any;
    relayServer?: any;
    static Types: typeof TLVValues;
    static TLVValues: typeof TLVValues;
    static Codes: typeof Codes;
    ...
    constructor(accessoryInfo: any, relayServer?: any);
    ...
    _onRemoteRequest: (request: HapRequest, remoteSession: RemoteSession, session: Session, events: any) => void;
    ...
    _onSessionClose: (sessionID: string | Buffer, events: any) => void;
    /**
    ...
    _handleRemotePairVerify: (request: HapRequest, remoteSession: RemoteSession, session: Session) => void;
    _handleRemotePairVerifyStepOne: (request: HapRequest, remoteSession: RemoteSession, session: Session, objects: Record<number, Buffer>) => void;
    _handleRemotePairVerifyStepTwo: (request: HapRequest, remoteSession: RemoteSession, session: Session, objects: Record<number, Buffer>) => void;
    /**
    ...
    _handleRemoteAccessories: (request: HapRequest, remoteSession: RemoteSession, session: Session) => void;
    ...
    _handleRemoteCharacteristicsWrite: (request: HapRequest, remoteSession: RemoteSession, session: Session, events: any) => void;
    _handleRemoteCharacteristicsRead: (request: HapRequest, remoteSession: RemoteSession, session: Session, events: any) => void;
}
/**
