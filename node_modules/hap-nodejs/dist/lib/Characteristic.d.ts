...
import { CharacteristicChange, CharacteristicValue, HapCharacteristic, Nullable, ToHAPOptions, VoidCallback } from '../types';
...
export declare enum CharacteristicEventTypes {
    GET = "get",
    SET = "set",
    SUBSCRIBE = "subscribe",
 ...
 */
export declare type EventCharacteristic = CharacteristicEventTypes.GET | CharacteristicEventTypes.SET | CharacteristicEventTypes.SUBSCRIBE | CharacteristicEventTypes.UNSUBSCRIBE | CharacteristicEventTypes.CHANGE;
/**
...
export declare class Characteristic extends EventEmitter<Events> {
    ...
    constructor(displayName?: string | undefined, UUID?: string | undefined, props?: CharacteristicProps);
    /**
    ...
    setValue: (newValue: Nullable<string | number | boolean | Error | (string | number | boolean)[] | {
        [key: string]: string | number | boolean;
    }>, callback?: CharacteristicSetCallback | undefined, context?: any, connectionID?: string | undefined) => Characteristic;
    updateValue: (newValue: Nullable<string | number | boolean | Error | (string | number | boolean)[] | {
        [key: string]: string | number | boolean;
    }>, callback?: (() => void) | undefined, context?: any) => Characteristic;
