...
var TargetControlSupportedConfiguration = /** @class */ (function (_super) {
    ...
    function TargetControlSupportedConfiguration() {
        ...
        _this.setProps({
            ...
            perms: [Characteristic_1.Perms.PAIRED_READ]
        });
...
var TargetControlList = /** @class */ (function (_super) {
    ...
    function TargetControlList() {
        ...
        _this.setProps({
            format: Characteristic_1.Formats.TLV8,
            perms: [Characteristic_1.Perms.PAIRED_WRITE, Characteristic_1.Perms.PAIRED_READ, Characteristic_1.Perms.WRITE_RESPONSE]
        });
        _this.value = _this.getDefaultValue();
        _this.accessRestrictedToAdmins = [Characteristic_1.Access.READ, Characteristic_1.Access.WRITE];
        return _this;
    }
...
var ButtonEvent = /** @class */ (function (_super) {
    ...
    function ButtonEvent() {
        ...
        _this.value = _this.getDefaultValue();
        _this.accessRestrictedToAdmins = [Characteristic_1.Access.NOTIFY];
        return _this;
    }
...
var SelectedAudioStreamConfiguration = /** @class */ (function (_super) {
    ...
    function SelectedAudioStreamConfiguration() {
        ...
        _this.setProps({
            format: Characteristic_1.Formats.TLV8,
            perms: [Characteristic_1.Perms.PAIRED_READ, Characteristic_1.Perms.PAIRED_WRITE]
        });
        _this.value = _this.getDefaultValue();
        return _this;
    }
