...
// @ts-ignore
lightAccessory.category = __1.Categories.LIGHTBULB;
...
lightAccessory.on(__1.AccessoryEventTypes.IDENTIFY, function (paired, callback) {
...
lightAccessory
    ...
    .on(__1.CharacteristicEventTypes.SET, function (value, callback) {
    ...
    .on(__1.CharacteristicEventTypes.GET, function (callback) {
