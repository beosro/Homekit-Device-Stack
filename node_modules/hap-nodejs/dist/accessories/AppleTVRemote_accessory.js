...
remote.category = __1.Categories.TARGET_CONTROLLER;
// ----------------- for siri support -----------------
...
var controller = siriSupport
    ? new __1.HomeKitRemoteController(gstreamer_audioProducer_1.GStreamerAudioProducer, gstreamerOptions)
    : new __1.HomeKitRemoteController();
...
http.createServer(function (request, response) {
    ...
    if (pathname === "setActiveTarget") {
        ...
        if (buttonState === __1.ButtonState.UP) {
            controller.releaseButton(button);
        }
        else if (buttonState === __1.ButtonState.DOWN) {
